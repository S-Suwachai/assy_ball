...
class Chart_PD_MD extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      dataMC : localStorage.getItem('dataMC')
    };
  }

  componentDidMount = async () => {
    console.log("00000000000000000000000");
    await console.log(this.state.dataMC)
    await this.dateChange();
    await this.getOutput_MBR_MD();
    this.timer = setInterval(this.tick, 1000);
    // await this.setState({ dataMC: ""})
  };
